...
const pdfPath = path.join(projectRoot, 'data/endometriosis-booklet.pdf');
    ...
    const systemMessage = useRAG
        ? {
            ...
            content: sources.length > 0
                ? `You are a helpful assistant when it comes to General knowledge on Endometriosis. You must ONLY use the information provided below to answer.\n\n--- ENDOMETRIOSIS BOOKLET EXCERPTS ---\n${sources.join('\n\n')}\n--- END OF EXCERPTS ---`
                : `You are a helpful assistant when it comes to General knowledge on Endometriosis. The excerpts do not contain relevant information for this question. Reply politely: \"I'm sorry, I don't know. The endometriosis booklet does not contain information about that.\"`,
        }
        : {
            role: "system",
